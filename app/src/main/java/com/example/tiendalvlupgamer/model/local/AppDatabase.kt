    ...
    companion object {
        ...
        fun get(context: Context): AppDatabase =
            INSTANCE ?: synchronized(this) {
                // La única línea que cambia es la adición de .addCallback()
                INSTANCE ?: Room.databaseBuilder(
                    ...
                    .addCallback(AppDatabaseCallback()) // <-- AÑADE ESTA LÍNEA
                    .build()
                    .also { INSTANCE = it }
            }
        private class AppDatabaseCallback : RoomDatabase.Callback() {
            override fun onCreate(db: SupportSQLiteDatabase) {
                ...
                // Obtenemos la instancia y lanzamos una corutina para insertar los datos
                // Usamos Dispatchers.IO porque es una operación de disco (I/O)
        ...
        // Tu lista de productos, ahora como una constante
